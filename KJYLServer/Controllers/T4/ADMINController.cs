...
namespace KJYLServer.Controllers
{
    ...
    public partial class ADMINController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Get(int pageIndex, int pageSize)
        {
            try
            {
                Tuple<IQueryable<ADMIN>, int> getResult = await bll.SelectPageList<string>(p => true, p =>p.ADMIN_ID, pageIndex, pageSize);             
        ...
        public async Task<IHttpActionResult> Get(string id)
        {
            try
            {
                ADMIN model = await bll.SelectOne(p => p.ADMIN_ID == id);
        ...
        public async Task<IHttpActionResult> Put([FromBody]ADMIN value)
        {
            try
            {
                ...
                string sqlStr = sql.GetUpdateSql(value, value.ADMIN_ID.ToString());               
